...
// Only Windows is advertised for now, so this is the only installer URL the
// page builds. The backend still returns the macOS and Linux assets for the
// same release (see desktop-release.ts) — bringing those cards back is adding
// markup, not re-plumbing the lookup.
        ...
        <div className="wrap">
          ...
          >
            ...
            <p className="lead" style={{ margin: "14px auto 0" }}>
              Katta ekranda yanada qulayroq boshqaring. Windows uchun maxsus
              ilova.
            </p>
          </div>
